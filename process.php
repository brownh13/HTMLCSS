...
$yourName = "Heather Brown";

$yourEmail = "brown.heather0889@gmail.com";

$requiredFields = "name,email,question";

$successText = "YEAH! It's been submitted and we will get back to you soon!";

$errorText = "GO BACK! You didn't enter the required fields, silly!";

$replyURL = "confirm.php";

// OPTIONAL: names of radio, select options, and checkboxes to allow them to be required -- must also appear above for $requiredFields
$multiFields = "";
